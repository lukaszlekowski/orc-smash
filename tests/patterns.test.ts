...
describe('artifact path patterns', () => {
  ...
  it('render -> parse round-trips for the follow-up pattern', () => {
    const path = renderPattern(followUpPattern, { n: 1, agent: 'fake' });
